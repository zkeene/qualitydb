...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Html->link(__('Edit Pay Cycle'), ['action' => 'edit', $payCycle->id]) ?> </li>
        <li><?= $this->Form->postLink(__('Delete Pay Cycle'), ['action' => 'delete', $payCycle->id], ['confirm' => __('Are you sure you want to delete # {0}?', $payCycle->id)]) ?> </li>
